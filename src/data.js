export const projects = [
	{
		...
		name: 'ООО Главстрой СПБ',
		background: '/img/projects/1.jpg',
	...
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'ООО Секондстрой БПС',
		background: '/img/projects/2.jpg',
		logo: '/img/projects/2-logo.svg',
		work: `Работы по монтажу прифундаментного дренажа по адресу: `,
		address: 'ЛО, Всеволожский р-н, "Ручьи"',
		completed: true,
	},
...
export const vacancies = [
	{
		...
		requirements: [
			'Высшее образование, по специальности инженер-строитель, и стаж работы на руководящих инженерно-технических должностях не менее 5 лет.',
		],
		conditions: ['с 08-00 до 17-00, 5/2', 'сдельная оплата труда '],
	...
	},
	{
		...
		requirements: [
			'Высшее профессиональное (техническое) образование и стаж работы в строительстве на инженерно-технических должностях не менее 3 лет или',
			'Среднее профессиональное (техническое) образование и стаж работы в строительстве на инженерно-технических должностях не менее 5 лет.',
		],
		conditions: ['с 08-00 до 17-00, 5/2', 'сдельная оплата труда '],
...
export const suppliers = [
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'Pipelife',
		img: '/img/suppliers/1.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'Pragma',
		img: '/img/suppliers/2.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'СБРКС',
		img: '/img/suppliers/3.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'Полипластик',
		img: '/img/suppliers/4.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'Петроснаб',
		img: '/img/suppliers/5.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'Икапласт',
		img: '/img/suppliers/6.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'Logo',
		img: '/img/suppliers/7.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'Flotenk',
		img: '/img/suppliers/8.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'Parus',
		img: '/img/suppliers/9.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'AVK',
		img: '/img/suppliers/10.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'ATE',
		img: '/img/suppliers/11.svg',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: 'Сантехкомплект',
		img: '/img/suppliers/12.svg',
	},
];
...
export const technics = [
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: `Илососная  машина`,
		descr: 'КАМАЗ 65115 КО-530-01',
		img: '/img/technics/1.png',
		bgColor: '#0E0E0E',
		position: 'left',
	},
	{
		...
		descr: 'КАМАЗ 3572 КО-564-20',
		img: '/img/technics/2.png',
		bgColor: '#242424',
		position: 'left',
	},
	{
	...
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: `Экскаватор`,
		img: '/img/technics/5.png',
		bgColor: '#0E0E0E',
		position: 'left',
	},
	{
		_id: (Math.random() * 1234567890).toFixed(0),
		name: `КАМАЗ бортовой с КМУ`,
		img: '/img/technics/6.png',
		bgColor: '#0E0E0E',
		position: 'right',
	},
	{
