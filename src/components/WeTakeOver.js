...
const WeTakeOver = () => {
	...
	// 							<img
	// 								src={'/img/we-take-over/1-collection.svg'}
	// 								alt={'collection'}
	// 							/>
	// 						</div>
	// 						<div className='take-over_descr'>
	// 							Сбор и подготовка рабочей документации
	// 						</div>
	// 						<div className='take-over_arrow'>
	// 							<img
	// 								src={'/img/we-take-over/arrow-right.svg'}
	// 								alt={'arrow-right'}
	// 							/>
	// 						</div>
	// 					</div>
	...
	// 						<div className='take-over_img'>
	// 							<img
	// 								src={'/img/we-take-over/3-reconciliation.svg'}
	// 								alt={'reconciliation'}
	// 							/>
	// 						</div>
	...
	// 						<img
	// 							src={'/img/we-take-over/arrow-down.svg'}
	// 							alt={'arrow-down'}
	// 						/>
	// 					</div>
	// 				</div>
	...
	// 						<div className='take-over_arrow'>
	// 							<img
	// 								src={'/img/we-take-over/arrow-left.svg'}
	// 								alt={'arrow-left'}
	// 							/>
	// 						</div>
	// 					</div>
	...
	// 						<div className='take-over_img'>
	// 							<img
	// 								src={'/img/we-take-over/5-commissioning-works.svg'}
	...
	// 						<div className='take-over_img'>
	// 							<img
	// 								src={'/img/we-take-over/6-construction-works.svg'}
