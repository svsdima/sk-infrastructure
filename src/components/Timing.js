					...
					<div className='timing_wrapper'>
						<div className='timing_up'>
							...
							<div className='timing_day'>
								<p className='timing_day-meter'>
									{this.state.value ? this.state.value : '5000'}{' '}
									<span className='timing_day-text'>м*</span>
								</p>
								<div className='timing_day-dash'></div>
								<p className='timing_day-calc'>
									{Math.ceil((this.state.value / 1000) * 5)
										? Math.ceil((this.state.value / 1000) * 5)
										: '25-29'}{' '}
									<span className='timing_day-text'>рабочих дней*</span>
								</p>
							</div>
						</div>
