				...
				<div className='main-principles_wrapper'>
					<div className='main-principles_left'>
						...
						<div className='main-principles_list'>
							<div className='main-principles_item'>
								<div className='main-principles_item-img'>
									<img
										src='../../img/main/principles/1-guarantee.svg'
										alt='1-guarantee'
									/>
								</div>
							...
							<div className='main-principles_item'>
								<div className='main-principles_item-img'>
									<img
										src='../../img/main/principles/2-workers.svg'
										alt='2-workers'
									/>
								</div>
								<div className='main-principles_item_text'>
									<div className='main-principles_item_title'>
							...
							<div className='main-principles_item'>
								<div className='main-principles_item-img'>
									<img
										src='../../img/main/principles/3-helping_hand.svg'
										alt='3-helping_hand'
									/>
								</div>
								<div className='main-principles_item_text'>
						...
						<button className='btn btn-contacts'>
							<Link to='/contacts'>
								<span>Подробнее о контактах</span>
							</Link>
						</button>
					</div>
					<div className='main-principles_right'>
						...
						>
							<SwiperSlide className='main-principles-technic'>
								<div className='main-principles-technic_wrapper'>
									<img
										src='../../img/main/principles/slider/1-machinery.png'
										alt='1-machinery'
									/>
								</div>
							</SwiperSlide>
							<SwiperSlide className='main-principles-technic'>
								<div className='main-principles-technic_wrapper'>
									<img
										src='../../img/main/principles/slider/2-bulldozer.png'
										alt='2-bulldozer'
									/>
								</div>
							</SwiperSlide>
							<SwiperSlide className='main-principles-technic'>
								<div className='main-principles-technic_wrapper'>
									<img
										src='../../img/main/principles/slider/3-asphalt_paver.png'
										alt='3-asphalt_paver'
									/>
								</div>
							</SwiperSlide>
						...
						>
							...
							<SwiperSlide className='main-principles-text'>
								<div className='main-principles-text_subtitle'>
									Колесные экскаваторы JCB
								</div>
							</SwiperSlide>
							<SwiperSlide className='main-principles-text'>
								<div className='main-principles-text_subtitle'>
									Колесные бульдозеры JCB
								</div>
							</SwiperSlide>
							<SwiperSlide className='main-principles-text'>
								<div className='main-principles-text_subtitle'>
									Асфальтоукладчики JCB
								</div>
							</SwiperSlide>
						</Swiper>
					</div>
